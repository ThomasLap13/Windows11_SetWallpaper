...
if %errorLevel% neq 0 (
    ...
    powershell -Command "Start-Process PowerShell -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File \"%SCRIPT_DIR%sources\script_fond-ecran.ps1\"' -Verb RunAs"
    exit
)

:: Si le script est déjà exécuté en tant qu'administrateur, l'exécute normalement
powershell -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%sources\script_fond-ecran.ps1"
